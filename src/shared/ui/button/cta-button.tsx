    ...
    "disabled:cursor-not-allowed",
    {
        variants: {
            variant: {
                ...
                secondary:
                    "bg-gray-600 text-gray-50 hover:bg-gray-600/90 dark:text-gray-100",
                subtle:
                    "bg-gray-200 text-gray-500 hover:bg-gray-200/90",
                outline:
        ...
        return (
            <ShadButton
                ...
                className={cn(
                    ...
                    disabled &&
                    "opacity-100 bg-gray-200 text-gray-500 border-0 hover:bg-gray-200",
                    className
                )}
                disabled={disabled}
                {...props}
