  ...
  return (
    <div ref={rootRef} className={clsx("relative inline-block", className)}>
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className={clsx(
          "relative inline-flex h-14 w-80 items-center justify-between rounded-2xl border border-zinc-200 px-5",
      ...
      <div className="w-80 p-5">
        <div className="mb-3 flex items-center justify-between">
          <button
            ...
            aria-label="이전 달"
            onClick={onPrev}
            className="grid h-7 w-7 place-items-center rounded-md hover:bg-zinc-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-300"
          >
